...
(defcustom doxymacs-external-xml-parser-executable
  "/home/mofy/software/bin/doxymacs_parser"
...
(define-key doxymacs-mode-map "\C-c;?"
  'doxymacs-lookup)
(define-key doxymacs-mode-map "\C-c;r"
  'doxymacs-rescan-tags)

(define-key doxymacs-mode-map "\C-c;f"
  'doxymacs-insert-function-comment)
(define-key doxymacs-mode-map "\C-c;i"
  'doxymacs-insert-file-comment)
(define-key doxymacs-mode-map "\C-c;m"
  'doxymacs-insert-blank-multiline-comment)
(define-key doxymacs-mode-map "\C-c;s"
